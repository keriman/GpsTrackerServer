...
//*********variables globales***////////////////////
  ...
  var direccion = 0;
  var speed = 0;
  var velocidad_emulacion=80;
//////****************/////////////////////
function initMap() {

     var a = {lat: 19.702423, lng: -101.1945072};
...
//*************Colocar la Direccion del Servidor***************
 var baseimagen= 'http://sspmich.ngrok.io/ssp/vistas/imagenes/';
        var icons = {
          speedCero: {
...
function addMarkerLast(coordenada,info){

  if(speed == "0.000"){tipo = "ultima";  }
  else{
    if(direccion == null || direccion == 0.0 ){tipo = "ultima";}
    if((direccion >0 && direccion<=11.2) || (direccion > 348.7 && direccion<360)){tipo = "ultima";}
    if(direccion > 11.2 && direccion<=33.7){tipo = "ultima";}
    if(direccion > 33.7 && direccion<=56.2){tipo = "ultima";}
    if(direccion > 56.2 && direccion<=78.7){tipo = "ultima";}
    if(direccion > 78.7 && direccion<=101.2){tipo = "ultima";}
    if(direccion > 101.2 && direccion<=123.7){tipo = "ultima";}
    if(direccion > 123.7 && direccion<=146.2){tipo = "ultima";}
    if(direccion > 146.2 && direccion<=168.7){tipo = "ultima";}
    if(direccion > 168.7 && direccion<=191.2){tipo = "ultima";}
    if(direccion > 191.2 && direccion<=213.7){tipo = "ultima";}
    if(direccion > 213.7 && direccion<=236.2){tipo = "ultima";}
    if(direccion > 236.2 && direccion<=258.7){tipo = "ultima";}
    if(direccion > 258.7 && direccion<=281.2){tipo = "ultima";}
    if(direccion > 281.2 && direccion<=303.7){tipo = "ultima";}
    if(direccion > 303.7 && direccion<=326.2){tipo = "ultima";}
    if(direccion > 326.2 && direccion<=348.7){tipo = "ultima";}
  }
